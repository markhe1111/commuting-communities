...
source('/Users/markhe/Dropbox/regiondemarcation/code/git/community-analysis/Preprocessing/util.R')
EDC = read.csv('/Users/markhe/Dropbox/regiondemarcation/rawdata/C2010_wdc_v2.csv')
...
register_EDC2<-function(EDC, key){
  ...
  run_regionsplit_100<-function( ){
    ...
    setwd('/Users/markhe/Dropbox/regiondemarcation/Regionsplitdata/')
    setwd('threshold_100/')
...
islands = get_island_sample( E , sig = .05, key_j=key)
islands_05 = islands[islands$Freq==10000,]
